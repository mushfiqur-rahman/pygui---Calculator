...
# Eq & Clear
btn_clear = tk.Button(root, text="CE", command=clear_field,
                      width=11, font=("Arial", 14))
btn_clear.grid(row=6, column=1, columnspan=2)
btn_equals = tk.Button(root, text="=", command=evaluate__to_calculation,
                       width=11, font=("Arial", 14), bg='gray')
